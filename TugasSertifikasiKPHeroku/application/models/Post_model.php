...
class Post_model extends CI_Model
{
    ...
    public function banyakPostStatus($keyword)
    {
        return $this->db->like('status', $keyword)->from('posts')->count_all_results();
    }
    ...
    public function getPencarianStatus($limit, $start, $keyword)
    {
        return $this->db
            ->select("id_post,judul, SUBSTRING(deskripsi, 1,200) as isi,genre,episode,max_episode,status")
            ->like('status', $keyword)
