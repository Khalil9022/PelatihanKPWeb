                ...
                <div class="card mx-4" style="width: 40rem;">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" name="judul" value="<?= set_value('judul') ?>">
                            <?= form_error('judul', '<small class = "text-danger">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">isi</label>
                            <textarea name="isi" id="isi" rows="5" class="form-control" value="<?= set_value('isi') ?>"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <input type="number" id="" name="episode" value="<?= set_value('episode') ?>"> /
                            <input type="number" id="" name="max_episode" value="<?= set_value('max_episode') ?>">
                            <br>
