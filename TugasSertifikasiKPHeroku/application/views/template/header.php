    ...
    <div class="container">
        <header class="blog-header py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                ...
                <div class="col-4 d-flex justify-content-end align-items-center">
                    ...
                    <?php if (logged_in()) : ?>
                        <a class="btn btn-sm btn-outline-secondary my-2 my-sm-0 mx-3" href="<?= base_url() ?>posts/tambah"><i class="far fa-plus-square"></i></a>
        ...
        <div class="nav-scroller py-1 mb-2">
            <nav class="nav d-flex justify-content-between bg-warning">
                ...
                <form action="<?= base_url(); ?>posts/status" method="POST" class="">
                    <input type="hidden" value="Completed" name="keywordStatus">
                    <button class="p-2 text-muted btn text-muted " type="submit" name="submit">Complete</button>
                </form>
                <form action="<?= base_url(); ?>posts/status" method="POST" class="">
                    <input type="hidden" value="OnGoing" name="keywordStatus">
                    <button class="p-2 text-muted btn text-muted " type="submit" name="submit">OnGoing</button>
                </form>
